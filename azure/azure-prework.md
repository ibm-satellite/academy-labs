...
Create the Azure environment, in TechZone in this demo collection, in environment section, click on resource named '***Request Azure Infrastructure for Satellite location'*** to obtain AZURE API credentials to use compute and storage.
...
In IBM Cloud Catalog https://cloud.ibm.com/catalog look for "Object Storage"
...
6. Change the host profile selected for the Azure VMs. Use Standard_D16as_v4, this is 16vCPU, 64GB Memory and 128GB disk.
...
If this fails, that usually fails then remove resources using the Azure CLI

### Using Azure CLI

#### Gather azure resource group
...
Using student VSI. See [Student VSI](https://github.com/ibm-satellite/academy-labs/tree/main/common/student-vsi)
