var FindProxyForURL = function(init, profiles) {
    ...
    "+proxy": function(url, host, scheme) {
        ...
        if (/^console-openshift-console\.xxx-xxx-0000\.us-south\.containers\.appdomain\.cloud$/.test(host)) return "HTTPS c-04.private.us-south.link.satellite.cloud.ibm.com:yyyyy";
